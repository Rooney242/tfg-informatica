...
plot 'data/multicore-max-rate-intel.dat' using 1:($2/1024) w linespoints ls 1 lw 3 title '1 Hilo', \
	# 'data/multicore-max-rate-intel.dat' using 1:($3/1024) w linespoints ls 2 lw 3 title '2 Hilos', \
	#'data/multicore-max-rate-intel.dat' using 1:($4/1024) w linespoints ls 3 lw 3 title '4 Hilos', \
