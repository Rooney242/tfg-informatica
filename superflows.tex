\documentclass[tfg,epsbased,lof,lot,loa,covers,final,nocopyright,overleaf]{tfgtfmthesisuam}
...
\renewcommand*{\bibfont}{\raggedright}%TODO: es correcto que la bibliografía este a la izquierda
  ...
  \Pn{RESOLVE\_DEVICES(superflows)}{
        ...
        \ForEach{device \textbf{in} unresolved\_devices}{
            ...
            \While{remain\_in\_macs \textbf{is not} EMPTY}{
                ...
                new\_device.out\_macs.APPEND(device.out\_mac)\;
                remain\_out\_macs.APPEND(device.out\_mac)\;
                }
