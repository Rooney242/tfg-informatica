\begin{tikzpicture}
\node[palette1, fill = palette1!30!white, text = black, rectangle, draw, minimum height = 2.5cm, minimum width = 1.5cm] (skadi) at (0,0) {\footnotesize skadi};
\node[palette2, fill = palette2!30!white, text = black, rectangle, draw, minimum height = 2.5cm, minimum width = 1.5cm] (einsrepo) at (4,0) {\footnotesize einsrepo};
