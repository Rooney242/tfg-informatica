...
\fill[pattern = vertical lines, pattern color = palette2!30!white] (0,0) rectangle (2, 1);
...
\fill[pattern = vertical lines, pattern color = palette2!30!white] (0,0) rectangle (3, 1);
\node[rotate = 90] at (0.25, 0.5) {Pad.};
\draw[dotted] (0.5, 0) -- (0.5, 1);
